...
const savingsAfter12Months = monthlyContribution * months;
console.log(
  "Simon will manage to save " +
    savingsAfter12Months +
    "€ after 12 months, which will give him a total of " +
    totalSavings +
    "€ combined with his already saved money.",
);
