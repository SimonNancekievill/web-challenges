...
function findByLastName(employees, lastName) {
  ...
  // return employees.find((employee) => employee.includes(lastName)); hier würde es auch funktionieren wenn ich über employee.lastName gehen würde weil es wieder ein string ist.
...
function findByCitySubString(employees, string) {
  ...
  // return employees.find((employee) => employee.city.includes(string)); funktioniert weil employee.city ein string ist!
}
